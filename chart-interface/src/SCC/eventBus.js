...
export const EVENTS = {
    ...
    LINE_PHASE_STYLE_CHANGED: 'line:phase_style_changed',
    LINE_AIM_SAVED: 'line:aim_saved',
    LINE_AIM_STYLE_CHANGED: 'line:aim_style_changed',
    LINE_CEL_SAVED: 'line:cel_saved',
    LINE_CEL_STYLE_CHANGED: 'line:cel_style_changed',
    LINE_CEL_SETTINGS_CHANGED: 'line:cel_settings_changed',
    LINE_CUT_SAVED: 'line:cut_saved',
...
const EVENT_CATEGORY_MAP = {
    ...
    [EVENTS.LINE_PHASE_STYLE_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_AIM_SAVED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_AIM_STYLE_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_CEL_SAVED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_CEL_STYLE_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_CEL_SETTINGS_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_CUT_SAVED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_REMOVED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.LINE_VISIBILITY_CHANGED]: [EVENT_CATEGORIES.PRESENTATION],
    ...
    // Fan
    [EVENTS.FAN_VISIBILITY_CHANGED]: [EVENT_CATEGORIES.PRESENTATION],

    // Chart settings
    [EVENTS.CHART_NAME_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.CHART_TYPE_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.CHART_WINDOW_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.CHART_HEIGHT_CHANGED]: [EVENT_CATEGORIES.STATE_MUTATING],
    [EVENTS.CHART_GRID_VISIBILITY_CHANGED]: [EVENT_CATEGORIES.PRESENTATION],
    [EVENTS.CHART_ZEROS_CHANGED]: [EVENT_CATEGORIES.PRESENTATION],
    [EVENTS.CHART_SHARED]: [EVENT_CATEGORIES.STATE_MUTATING],

    // Series visibility
    [EVENTS.SERIES_VISIBILITY_CHANGED]: [EVENT_CATEGORIES.PRESENTATION],
    ...
    [EVENTS.UI_LEGEND_RENDER]: [EVENT_CATEGORIES.PRESENTATION],
    [EVENTS.UI_LEGEND_VISIBILITY_CHANGED]: [EVENT_CATEGORIES.PRESENTATION],
