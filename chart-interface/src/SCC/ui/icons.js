...
export const icons = {
    ...
    jsonExport: (size = null) => `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" ${sizeAttrs(size)}>
            ...
            <text x="320" y="445" text-anchor="middle" font-size="180" font-family="monospace" fill="currentColor" pointer-events="none">{}</text>
        </svg>
    `,

    fullscreenExpand: (size = null) => `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" ${sizeAttrs(size)}>
    ...
    viewOnly: (size = null) => `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" ${sizeAttrs(size)}>
